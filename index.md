...
carpentry: "Online"    # what kind of Carpentry (must be either "lc" or "dc" or "swc")
venue: "West Virginia University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "FXME"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
